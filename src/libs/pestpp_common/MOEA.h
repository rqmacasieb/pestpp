...
private:
	...
	vector<double> get_euclidean_distance(map<string, double> first, map<string, double> second, map<string, double> objrange);
	...
	map<string, map<string, double>> extreme_members;
